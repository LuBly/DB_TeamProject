...
public class DB_Connect {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String CreatePolicyInfo = "Create Table PolicyInfo(bizId varchar(100),polyBizSjnm varchar(100),polyItcnCn varchar(100),plcyTpNm varchar(200),rqutPrdCn varchar(100),rqutUrla varchar(100),polyBizTy varchar(100),AgeInfo varchar(100),empmSttsCn varchar(100), accrRqisCn varchar(100), majrRqisCn varchar(300), splzRlmRqisCn varchar(200));";
